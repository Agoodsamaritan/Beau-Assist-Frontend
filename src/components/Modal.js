...
export default function Modal() {
  ...
  return (
    <>
        <button className="fixed bottom-24 left-24 bg-white rounded-md p-2 inline-flex items-center justify-center text-black hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" 
        type="button"> 
        ...
        <button className="fixed bottom-0 left-3 mb-7 mr-7" type="button" onClick={() => setShowModal(true)}>
